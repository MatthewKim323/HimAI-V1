...
export default function App() {
  ...
  const loadExercises = async () => {
    try {
      const response = await fetch('http://169.231.214.251:8000/tension/exercises');
      if (response.ok) {
  ...
  const pickVideo = async () => {
    try {
      ...
      if (!result.canceled && result.assets[0]) {
        ...
        setUploadedVideo({
          uri: video.uri,
          name: video.fileName || 'exercise_video.mp4',
          type: 'video/mp4',
          size: video.fileSize,
        });
        setUploadProgress(0);
  ...
  const uploadVideo = async () => {
    ...
    try {
      ...
      const response = await fetch('http://169.231.214.251:8000/tension/analyze', {
        method: 'POST',
        body: formData,
      ...
      {activeTab === 'home' ? (
        ...
        <View style={styles.foodContainer}>
          ...
          <View style={styles.catalogHeader}>
            <View style={styles.catalogTitleContainer}>
              <Text style={styles.catalogTitle}>
                The Catalog ({recentFoods.length.toLocaleString()} foods)
                {usingBackend && <Text style={styles.backendIndicator}> 🐍</Text>}
              </Text>
            </View>
          ...
          <View style={styles.foodSearchContainer}>
            ...
            {/* Meal History Section - Bottom 50% */}
          ...
          <View style={styles.strongPopupContainer}>
            ...
            <View style={styles.strongButtonContainer}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  setActiveWorkout(selectedTemplate);
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                  try {
                    ...
                    const res = await fetch('http://169.231.214.251:8000/insights/report', {
                      method: 'POST',
